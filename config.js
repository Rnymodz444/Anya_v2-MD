...
global.botname = process.env.BotName || "RnyBotz" 
global.author = process.env.Author || "@PikaBotz" 
global.packname = process.env.PackName || "RnyBotz v2 MD" 
global.myweb = process.env.Web || "https://github.com/PikaBotz" 
global.footer = process.env.Footer || "© RnyModz Bot" 
global.prefa = process.env.Prefix || ['-'] 
global.themeemoji = process.env.ThemeEmoji || "🎐" 
global.ownername = process.env.Owner_Name || "Pika~Kun" 
global.ownernumber = process.env.Owner_Number || "6285945900054" 
...
module.exports = {
  botname: process.env.BotName || "RnyBotz", 
  author: process.env.Author || "@PikaBotz",
  packname: process.env.PackName || "RnyBotz v2 MD",
  myweb: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© RnyBotz Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Pika~Kun",
  ownernumber: process.env.Owner_Number || "6285945900054",
